...
<template>
  <div class="company">
    <h1>Country:</h1>
    <el-select v-model="country" placeholder="Select" style="width:400px; margin-left:20px" class="flagcontainer" >
      <template slot="prefix">
        <span :class="['prefix flag-icon flag-icon-'+ country.toLowerCase() ]"></span>
      </template>
      <el-option v-for="item in countries" :key="item.code" :label="item.name" :value="item.code">
         <span :class="['flag-icon flag-icon-'+ item.code.toLowerCase() ]"></span>
        {{ item.name }}
      </el-option>
    </el-select>
  </div>
